  ...
  return (
    ...
    >
      ...
      <MenuItems
        ...
        anchor="bottom start"
        className={clsx(
          "absolute z-50 right-0 mt-2 w-max max-w-full min-w-56 origin-top-right divide-y divide-gray-100 rounded-md bg-white shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none",
...
const MenuBtn: React.FC<MenuBtnProps> = ({ label, onClick, close }) => {
  ...
  return (
    <CustomButton onClick={handleClick} className={clsx(...menuItemStyles)}>
      {label}
    </CustomButton>
  );
};
