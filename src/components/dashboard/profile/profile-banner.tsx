      ...
      <BannerContainer>
        <div className="flex flex-wrap gap-10 sm:px-10 pt-0 sm:pt-14 pb-14 w-full max-w-4xl sm:backdrop-blur-lg sm:bg-black/30 sm:rounded-2xl relative">
          <div className="flex flex-wrap gap-5 sm:gap-7 w-full text-white">
            ...
            <div className="w-full text-base md:text-lg text-b2b-lv1">{buyer.company_description}</div>
          </div>
          <CustomButton component={Link} href={Routes.public.home} className="px-8 py-4 bg-white border border-solid border-white/20 shadow-btn rounded-[0.5rem] font-medium sm:text-lg text-base text-b2b-lv6">
            Get in touch →
          </CustomButton>
        </div>
      </BannerContainer>
