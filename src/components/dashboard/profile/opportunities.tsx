  ...
  return (
    <Section title="Opportunities">
      <ProfileCard
        ...
        icon={<Discover color="var(--b2b-lv2)" />}
      ...
      <ProfileCard
        ...
        icon={<Cooperation color="var(--b2b-lv2)" />}
      ...
      <ProfileCard
        ...
        icon={<MoneyBag color="var(--b2b-lv4)" />}
        title={<span className="text-b2b-lv4">Estimated Budget</span>}
      >
        <div className="flex flex-col gap-2.5">
          <div className="text-b2b-lv6 text-2xl sm:text-[1.75rem] font-bold">
            USD {buyer.estimated_procurement_amount}
          </div>
